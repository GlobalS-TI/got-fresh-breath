  ...
  return (
    <section className="relative h-[32rem] overflow-hidden bg-slate-800 md:h-[36rem]">
      <MediaSlot
        ...
        mediaClassName="absolute inset-0 h-full w-full object-cover object-[center_20%]"
      />
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl flex-col justify-end gap-4 px-6 pb-12 md:justify-center md:pb-0">
        ...
        <p className="max-w-sm text-sm leading-relaxed text-white/80">
          Got Fresh Breath transforma los sanitarios de tus colaboradores y visitas en un estándar
          de presentación impecable. Les damos la seguridad total para interactuar, hablar y
          reunirse con confianza absoluta.
        </p>
        <Link
          href="/sectores"
